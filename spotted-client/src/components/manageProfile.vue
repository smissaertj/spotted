<template>
  <div
    class="card flex shadow-2xl bg-base-200 rounded-box place-items-center h-full w-full"
  >
      ...
      >
        <div class="form-control">
          <label class="input-group">
            <span class="label-text bg-accent text-accent-content"
              >Username</span
            >
        ...
        <div class="form-control mt-2">
          <label class="input-group">
            <span class="label-text bg-accent text-accent-content">Email</span>
            <vee-field
              type="email"
              placeholder=""
              class="input input-bordered w-full"
